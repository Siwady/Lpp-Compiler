...
GreaterAndEqualThanNode::~GreaterAndEqualThanNode()
{
	delete LeftNode;
	delete RightNode;
}

Value* GreaterAndEqualThanNode::Interpret()
{
...
GreaterAndEqualThanNode::GreaterAndEqualThanNode(ExpressionNode *left, ExpressionNode *right, int row, int column)
{
    this->LeftNode=left;
...
Type *GreaterAndEqualThanNode::ValidateSemantic()
{
